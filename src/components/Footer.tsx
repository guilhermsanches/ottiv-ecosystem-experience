...
const Footer: React.FC = () => {
  return (
    <footer className="bg-ottiv-navy text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-white/70 mb-6 max-w-xs">
              OTTIV delivers premium AI-powered digital solutions that transform businesses and drive exceptional growth.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#lab" className="text-white/70 hover:text-white transition-colors">OTTIV LAB</a>
              </li>
              <li>
                <a href="#crew" className="text-white/70 hover:text-white transition-colors">OTTIV CREW</a>
              </li>
              <li>
                <a href="#data" className="text-white/70 hover:text-white transition-colors">OTTIV DATA</a>
              </li>
              <li>
                <a href="#flow" className="text-white/70 hover:text-white transition-colors">OTTIV FLOW</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/60 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} OTTIV. All rights reserved.
            </p>
